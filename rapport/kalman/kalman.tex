...
201 objets SSO, 825\,247 TLE, 698 objet-an. Canal du demi-grand axe contre les manoeuvres
in-track, seuil $\chi^2_1$ à 0,997, appariement au plus proche à 1,5 jour. Les paramètres
$(\mathrm{var}_Q, r, p_0)$ sont optimisés par évolution différentielle sur une F1 lissée.

Quatre réglages sont comparés : un jeu de paramètres par objet, un jeu par cluster
d'objets, et un jeu unique pour tous. Les clusters sont obtenus par HDBSCAN, soit sur des
grandeurs observables directement (demi-grand axe, inclinaison, excentricité, $B^*$,
cadence du catalogue, bruit haute fréquence), soit sur les représentations à 128 dimensions
de l'encodeur préentraîné. Le nombre entre parenthèses est le nombre d'optimisations
nécessaires.

\begin{center}
\small
\input{figures/kalman_tab_resultats}
\end{center}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/kalman_detections.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/kalman_nis_exemple.png}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{figures/kalman_configs.png}
\end{figure}
