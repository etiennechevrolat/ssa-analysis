...
Même avec des paramètres optimisés au cas par cas, une partie des satellites reste en catégorie fail : leur pattern of life (bruit TLE, cadence de manoeuvres, densité de mesures) ne se prête pas à une détection par seuillage statistique de la NIS.
...
Pour chaque catégorie, on retient le satellite de F1 médiane et on trace : (i) l'évolution des paramètres orbitaux superposée aux manoeuvres prédites, avec les paramètres optimaux ; (ii) la NIS en pics (seuil $\chi^2_1$, détections en rouge, manoeuvres vraies en vert) pour les trois configurations de paramètres.

\paragraph{Exemple fail ($F1 < 0.5$).}
\begin{center}
    \includegraphics[width=0.98\textwidth]{figures/kalman_fail_optim_params.png}
\end{center}
\begin{center}
    \includegraphics[width=0.8\textwidth]{figures/kalman_fail_optim_nis.png}
    \includegraphics[width=0.8\textwidth]{figures/kalman_fail_avg_nis.png}
    \includegraphics[width=0.8\textwidth]{figures/kalman_fail_cluster_nis.png}
\end{center}

\newpage

\paragraph{Exemple mid ($0.5 \leq F1 < 0.7$).}
\begin{center}
    \includegraphics[width=0.98\textwidth]{figures/kalman_mid_optim_params.png}
\end{center}
\begin{center}
    \includegraphics[width=0.8\textwidth]{figures/kalman_mid_optim_nis.png}
    \includegraphics[width=0.8\textwidth]{figures/kalman_mid_avg_nis.png}
    \includegraphics[width=0.8\textwidth]{figures/kalman_mid_cluster_nis.png}
\end{center}

\newpage

\paragraph{Exemple good ($0.7 \leq F1 < 1$).}
\begin{center}
    \includegraphics[width=0.98\textwidth]{figures/kalman_good_optim_params.png}
\end{center}
\begin{center}
    \includegraphics[width=0.8\textwidth]{figures/kalman_good_optim_nis.png}
    \includegraphics[width=0.8\textwidth]{figures/kalman_good_avg_nis.png}
    \includegraphics[width=0.8\textwidth]{figures/kalman_good_cluster_nis.png}
\end{center}

\newpage

\paragraph{Exemple perfect ($F1 = 1$).}
\begin{center}
    \includegraphics[width=0.98\textwidth]{figures/kalman_perfect_optim_params.png}
\end{center}
\begin{center}
    \includegraphics[width=0.8\textwidth]{figures/kalman_perfect_optim_nis.png}
    \includegraphics[width=0.8\textwidth]{figures/kalman_perfect_avg_nis.png}
    \includegraphics[width=0.8\textwidth]{figures/kalman_perfect_cluster_nis.png}
\end{center}
