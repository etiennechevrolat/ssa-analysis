...
\begin{center}
    \includegraphics[scale=0.3]{Capture d’écran 2026-07-01 à 14.41.14.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=0.7]{Capture d’écran 2026-07-01 à 14.41.03.png}
\end{center}

Voici un résumé des noeuds de PoL d'un satellite du dataset.

\begin{center}
    \includegraphics[scale=0.4]{Capture d’écran 2026-07-01 à 14.41.33.png}
\end{center}
...
\section{Un dataset labellisé réel : les manoeuvres ILRS}

\subsection{Les données de manoeuvres ILRS}
...
\subsection{Confrontation aux séries temporelles TLE}
...
\begin{center}
    \includegraphics[width=0.48\textwidth]{s3b_sma.png}
    \includegraphics[width=0.48\textwidth]{s3b_eccentricity.png}
    \includegraphics[width=0.48\textwidth]{s3b_inclination.png}
    \includegraphics[width=0.48\textwidth]{s3b_raan.png}
    \includegraphics[width=0.48\textwidth]{s3b_arg_perigee.png}
    \includegraphics[width=0.48\textwidth]{s3b_mean_anomaly.png}
    \includegraphics[width=0.48\textwidth]{s3b_mean_motion.png}
\end{center}

\subsubsection{Envisat (NORAD 27386)}

\begin{center}
    \includegraphics[width=0.48\textwidth]{en1_sma.png}
    \includegraphics[width=0.48\textwidth]{en1_eccentricity.png}
    \includegraphics[width=0.48\textwidth]{en1_inclination.png}
    \includegraphics[width=0.48\textwidth]{en1_raan.png}
    \includegraphics[width=0.48\textwidth]{en1_arg_perigee.png}
    \includegraphics[width=0.48\textwidth]{en1_mean_anomaly.png}
    \includegraphics[width=0.48\textwidth]{en1_mean_motion.png}
\end{center}

\subsubsection{CryoSat-2 (NORAD 36508)}

\begin{center}
    \includegraphics[width=0.48\textwidth]{cs2_sma.png}
    \includegraphics[width=0.48\textwidth]{cs2_eccentricity.png}
    \includegraphics[width=0.48\textwidth]{cs2_inclination.png}
    \includegraphics[width=0.48\textwidth]{cs2_raan.png}
    \includegraphics[width=0.48\textwidth]{cs2_arg_perigee.png}
    \includegraphics[width=0.48\textwidth]{cs2_mean_anomaly.png}
    \includegraphics[width=0.48\textwidth]{cs2_mean_motion.png}
\end{center}

\subsubsection{SARAL (NORAD 39086)}

\begin{center}
    \includegraphics[width=0.48\textwidth]{srl_sma.png}
    \includegraphics[width=0.48\textwidth]{srl_eccentricity.png}
    \includegraphics[width=0.48\textwidth]{srl_inclination.png}
    \includegraphics[width=0.48\textwidth]{srl_raan.png}
    \includegraphics[width=0.48\textwidth]{srl_arg_perigee.png}
    \includegraphics[width=0.48\textwidth]{srl_mean_anomaly.png}
    \includegraphics[width=0.48\textwidth]{srl_mean_motion.png}
\end{center}
...
\subsection{Vérification de la loi de Gauss in-plane}
...
\begin{center}
    \includegraphics[width=0.85\textwidth]{cs2_delta_a_kalman_vs_theorique.png}
\end{center}
\begin{center}
    \includegraphics[width=0.85\textwidth]{s3b_delta_a_kalman_vs_theorique.png}
\end{center}
...
\subsection{Typologie des manoeuvres : composantes de $\Delta v$}
...
\begin{center}
    \includegraphics[width=0.85\textwidth]{cs2_dv_composantes.png}
\end{center}
\begin{center}
    \includegraphics[width=0.85\textwidth]{s3b_dv_composantes.png}
\end{center}
...
\subsection{Canal d'observation des manoeuvres out-plane}
...
On est dans le cas d'une orbite quasi-polaire ($i \sim 100°$) : la dérive de $\Omega$ liée au terme de perturbation du champ gravitationnel l'emporte.
...
$$
\dot{\Omega}_{J_2} = -\dfrac{3}{2} J_2 \left(\dfrac{R_T}{r}\right)^2 n \cos i \sim 1°/\text{jour}
$$
tandis que les variations dues aux manoeuvres sont de l'ordre de $0{,}01°/\text{jour}$.

Tout cela n'est plus vrai pour des orbites à faible inclinaison : si $i \sim 0°$, $\Omega$ varie en $\dfrac{1}{\sin i}$ et devient un canal d'observation valable (la discontinuité des paramètres angulaires nécessite alors d'ailleurs un changement de coordonnées vers les coordonnées équinoxiales).
...
\begin{center}
    \includegraphics[width=0.85\textwidth]{s3b_delta_i_kalman_vs_theorique.png}
\end{center}
